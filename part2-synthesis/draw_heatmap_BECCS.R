...
pot_steps <- seq(steps$pot_min[which(steps$net == "BECCS")], 
                 steps$pot_max[which(steps$net == "BECCS")], 
                 (steps$pot_max[which(steps$net == "BECCS")]-steps$pot_min[which(steps$net == "BECCS")])/steps$pot_n[which(steps$net == "BECCS")])
cost_steps <- seq(steps$cost_min[which(steps$net == "BECCS")], 
                  steps$cost_max[which(steps$net == "BECCS")],
                  (steps$cost_max[which(steps$net == "BECCS")]-steps$cost_min[which(steps$net == "BECCS")])/steps$cost_n[which(steps$net == "BECCS")])
