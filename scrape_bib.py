...
fpath = "/home/max/Documents/mcc/papers/NETS/NETs-review/Bibliography for GGR 2014-16 (v2) 20 Oct 2016s.html"
        ...
        for line in f:
            ...
            for l in lines:
                ...
                if ref is not None:
                    ...
                    if docs.count()==1:
                        doc = "http://apsis.mcc-berlin.net/scoping/doc/"+docs.first().UT
                    else:
                        doc = "not found"
                    w.write("{}\t{}\t{}\t{}\t{}\n".format(au,py,ti,section,doc))
                #else:
                    #print(l)
